...
public class MoreWindow extends PopupWindow implements OnClickListener{
	...
	public void showMoreWindow(View anchor,int bottomMargin) {
		final RelativeLayout layout = (RelativeLayout)LayoutInflater.from(mContext).inflate(R.layout.center_music_more_window1, null);
		setContentView(layout);
		final RelativeLayout contentLayout= (RelativeLayout) layout.findViewById(R.id.content_layout);
		ImageView close= (ImageView)layout.findViewById(R.id.center_music_window_close);
		close.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				if (isShowing()) {
					closeAnimation(contentLayout);
				}
			}
